...
# 10: call type '0' - non-API call, '1' - API call, '2' - direct Access, '3' - dependency, '4' - FP definition, '5' - FP call, '6' - reference, '7' - return const, '8' - return call, '9' - call with missed check, '10' - simple path, '11' - return NULL, '12' - return value checked by caller, '13' - return statement line
# For function call:
...
def	identify_const_macro(func, BB, ret_value):
	...
	if foundReturn:
		...
		if retVal[0] not in '0123456789':
			print("Identified macro", retVal, "as", ret_value)
			print('\tline', lineNo, 'for function', func, 'in file', fileName)
